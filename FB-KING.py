...
def banner():
  ...
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Sumon          {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801811376170          {N}{H}║
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/Hjdhbv");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/profile.php?id=100055859781950&mibextid=9R9pXO");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-KING {P}Terminal ');os.system("xdg-openhttps://www.facebook.com/profile.php?id=100055859781950&mibextid=9R9pXO");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.king.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/profile.php?id=100055859781950&mibextid=9R9pXO");mainx()
def mainx2():
    os.system("clear")
    banner()
